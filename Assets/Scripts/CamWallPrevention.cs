 ...
 * 
 * Initially I set the radius of the collider to be 0.55 and had the distToWall
...
public class CamWallPrevention : MonoBehaviour {
    ...
    [SerializeField] private float radiusReductionRate; //This is the value at which the radius decreases
